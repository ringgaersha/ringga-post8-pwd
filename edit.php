<?php
    ...
    if(isset($_POST['update'])){
        ...
        //update user data
        $result = mysqli_query($con,"UPDATE mahasiswa SET nim='$nim',namaMHS='$nama',jkel='$jkel',alamat='$alamat',tgllhr='$tgllhr' WHERE nim='$nim'");
    ...
    <body>
        ...
        <form name="update_mahasiswa" method="post" action="edit.php">
            <table border="0">
                <tr>
                    <td>Nama</td>
                    <td><input type="text" name="namaMHS" value=<?php echo $nama;?>></td>
                </tr>
                <tr>
                    <td>Gender</td>
